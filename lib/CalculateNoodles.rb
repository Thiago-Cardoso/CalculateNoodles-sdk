...
module CalculateNoodles
  class Error < StandardError; end
    ...
    def hourglass_one(time_cook, time_hourglass_one, time_hourglass_two)
    ...
    def hourglass_two(time_cook, time_hourglass_one, time_hourglass_two)
      (1..MAX_MULTIPLIER).each do |i|
    ...
    def calculate_time(time_cook, time_hourglass_one, time_hourglass_two)
      if solution = hourglass_one(time_cook, time_hourglass_one, time_hourglass_two)
        return solution
      end
      if solution = hourglass_two(time_cook, time_hourglass_one, time_hourglass_two)
        return solution
      end
